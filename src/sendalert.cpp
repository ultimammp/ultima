...
2. run ultimad with -printalert or -sendalert like this:
   /path/to/ultimad -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.ultima.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Ultima Core:0.12.0.58/"));
