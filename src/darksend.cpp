...
{
    if(fLiteMode) return; // ignore all Ultima related functionality
...
/*
    ...
    allow endless transaction that would bloat Ultima and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("ultima-privatesend");
