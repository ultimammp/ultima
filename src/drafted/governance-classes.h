 ...
 *
 *   // network
 *   CUltimaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.ultima.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CUltimaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: UltimaNetwork
// //   -- signature requirements : Key1(User)
// class CUltimaNetworkVariable : public CGovernanceObject
// {
// private:
