...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "UltimaNetwork") type = UltimaNetwork;
    if(strType == "UltimaNetworkVariable") type = UltimaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == UltimaNetwork) s = "UltimaNetwork";
    if(type == UltimaNetworkVariable) s = "UltimaNetworkVariable";
