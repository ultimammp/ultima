    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ULT-light"), QVariant("light"));
    ui->theme->addItem(QString("ULT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ULT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ULT-traditional"), QVariant("trad"));
