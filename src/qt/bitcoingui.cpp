    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Ultima Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ultima address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ultima: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Ultima Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ultima Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ultima Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ultima addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ultima addresses"));
    ...
    openAction->setStatusTip(tr("Open a ultima: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ultima Core help message to get a list with possible Ultima Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Ultima Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ultima network", "", count));
}
...
{
    QString strTitle = tr("Ultima Core"); // default title
