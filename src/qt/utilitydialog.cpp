    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Ultima Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Ultima Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ultima-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Ultima in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ULT, 0.1 ULT, 1 ULT and 10 ULT -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Ultima Core is shutting down...") + "<br /><br />" +
