...
This document provides guidelines for internationalization of the Ultima Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Ultima network</numerusform>
            <numerusform>%n active connections to Ultima network</numerusform>
        </translation>
    </message>
