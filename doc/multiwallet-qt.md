...
Only requiring some minor changes is ultima.cpp.
...
Changes to ultima.cpp
----------------------
ultima.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
