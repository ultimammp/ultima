...
This mechanism has been integrated into Bitcore-Node-Ultima which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ultimacoin/insight-api-ultima#web-socket-api](https://github.com/ultimacoin/insight-api-ultima#web-socket-api) 
* API: [https://github.com/ultimacoin/insight-api-ultima#instantsend-transactions](https://github.com/ultimacoin/insight-api-ultima#instantsend-transactions) 
...
By default, the Ultima Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ultima Core daemon:
